...
function ExpTimelineNode({ startDate, endDate, title, companyName, imageUrl, description }: TimeLineNodeOption) {
        ...
        <TimelineItem className={styles.item}>
            ...
            <TimelineContent>
                <Paper elevation={3}>
                    ...
                    <Typography variant="subtitle1" component="h2" className={styles.content}>
                        {companyName}
                    </Typography>
